...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 08 nov. 2022 à 14:43
...
CREATE TABLE `membre` (
  ...
  `mdphash` varchar(60) CHARACTER SET utf8mb4 NOT NULL,
  `confirmationmdp` int(11) NOT NULL,
  `validation_token` varchar(60) CHARACTER SET utf8mb4 DEFAULT NULL,
...
INSERT INTO `membre` (`Id_membre`, `prenom`, `nom`, `pseudo`, `email`, `adressePostale`, `codePostal`, `ville`, `mdphash`, `confirmationmdp`, `validation_token`, `confirmation_at`) VALUES
(77, 'charlene', 'lombardi', 'cha', 'charlene.lombardi@ik.me', '2 rue du vent', 83140, 'six fours', '$2y$10$pT20sHK4fwqyIndySRPEguos4coMQ5O/0de0iWU9msZwq6TcsLhm.', 0, NULL, '2022-11-08 14:22:47');
...
--
ALTER TABLE `membre`
  MODIFY `Id_membre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
